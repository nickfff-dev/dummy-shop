  ...
  <div className="ml-4 flex flex-1 flex-col">
    <div>
      <div className="flex justify-between text-base text-gray-900">
        ...
        <div className="flex px-1"><p className="border px-2 h-6  text-[12px] rounded border-gray-300">2</p>  <p className="ml-5 text-[12px]">${parseFloat(product.price).toLocaleString('en-Us')}</p></div>
      </div>
