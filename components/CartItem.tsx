      ...
      <div className="flex justify-between text-base text-gray-900">
        <h3 >
          <a href={product.href}>{product.name}</a>
            ...
            <div className="flex px-1"><p className="border px-2 h-6  text-[12px] rounded border-gray-300">{product.quantity}</p>  <p className="ml-5 text-[12px]">${(product.price * product.quantity).toFixed(2)}</p></div>
      </div>
