...
const Header = ({toggleCart}:{toggleCart:any}) => {
  return (
          ...
          <ul className=" flex items-center">
            ...
            <li className="relative ">
              <button className="" onClick={toggleCart}>
                <div className="absolute -top-1 right-0 z-10 bg-dummygreen text-xs text-white font-bold px-1 py-0.5 rounded-sm">12</div>
