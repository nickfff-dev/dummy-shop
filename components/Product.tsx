        ...
        alt={product.imageAlt}
          ...
          />
          {
            orderStart ? (<button className="flex someone bg-dummygreen rounded-full left-24 top-2 px-2 w-20 group-hover:w-full  group-hover:bg-[#004d23] group-hover:outline group-hover:outline-dummygreen group-hover:left-0 absolute text-white font-bold py-1 items-center justify-between "><svg width="24" onClick={() => {
              ...
              <svg onClick={() => {
              product.total = product.BOGOF === true ? (product.price * (( quantity + 1)/2)) : (product.price * (quantity +1))
                product.quantity = quantity + 1;
                setQuantity(quantity + 1)
                
              }} width="24" height="24" viewBox="0 0 24 24" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" color="systemGrayscale00"><path fillRule="evenodd" clipRule="evenodd" d="M12 3.5A1.5 1.5 0 0 1 13.5 5v5.5H19a1.5 1.5 0 0 1 1.493 1.355L20.5 12a1.5 1.5 0 0 1-1.5 1.5h-5.5V19a1.5 1.5 0 0 1-1.355 1.493L12 20.5a1.5 1.5 0 0 1-1.5-1.5v-5.5H5a1.5 1.5 0 0 1-1.493-1.355L3.5 12A1.5 1.5 0 0 1 5 10.5h5.5V5a1.5 1.5 0 0 1 1.355-1.493L12 3.5Z"></path></svg> </button>) : (<button onClick={() => { setOrderStart(true); product.total = product.BOGOF === true ? (product.price * (quantity  / 2)) : (product.price * quantity );   addTocart(product) }} className="flex someone bg-dummygreen rounded-full left-24 top-2 px-2 w-20 group-hover:w-full  group-hover:bg-[#004d23] group-hover:outline group-hover:outline-dummygreen group-hover:left-0 absolute text-white font-bold py-1 items-center justify-between "><svg width="24" height="24" viewBox="0 0 24 24" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" color="systemGrayscale00"><path fillRule="evenodd" clipRule="evenodd" d="M12 3.5A1.5 1.5 0 0 1 13.5 5v5.5H19a1.5 1.5 0 0 1 1.493 1.355L20.5 12a1.5 1.5 0 0 1-1.5 1.5h-5.5V19a1.5 1.5 0 0 1-1.355 1.493L12 20.5a1.5 1.5 0 0 1-1.5-1.5v-5.5H5a1.5 1.5 0 0 1-1.493-1.355L3.5 12A1.5 1.5 0 0 1 5 10.5h5.5V5a1.5 1.5 0 0 1 1.355-1.493L12 3.5Z"></path></svg><p className="group-hover:before:content-['Add_to_cart']  before:content-['Add'] "></p> </button>)
          }
